    ...
    function procurar() {
        ...
        if (b == '1 sexta' || b == 'primeira sexta') {
            res.innerHTML = `<p><strong>1ª Sexta - Hora: 19:30</strong></p>
                             <p>Jd. Liberdade<br>Marialva - Central<br>Jd. Nova Aliança (SDI)<br>Jd. Nova Independência (SDI)<br>Pulinópolis (MÇU)<br>Cafeara (JTÃ)<br>Jd. Pioneiro (PDU)</p>`;  
        } else if (b == '2 sexta' || b == 'segunda sexta') {
            res.innerHTML = `<p><strong>2ª Sexta - Hora: 19:30</strong></p>
                             <p>Jd. Catedral<br>Jd. Piatã<br>Jd. Ebenezer<br>Jd. Montreal - Indiaiá<br>Jd. Olímpico<br>Vila Guardiana (MÇU)<br>Jd. Ouro Verde II (SDI)<br>Jd. das Torres (SDI)<br>Jaguapirã - Central<br>Conj. João de Barros (MVA)<br>Àgua Boa - Central</p>`;  
        } else if (b == '3 sexta' || b == 'terceira sexta') {
            res.innerHTML = `<p><strong>3ª Sexta - Hora: 19:30</strong></p>
                             <p>Conj. Guaiapó<br>Jd. Ouro Cola<br>Maringá Velho<br>Pq. Residencial Tuiuti<br>Vila Operária<br>Pq. Tarumã (Os ensaios serão na igreja Jd. Catedral)<br>Residencial São José (SDI)<br>Miraselva (JTÃ)<br>Dr. Camargo - Central<br>Sarandi - Central<br>Jd. São Rafael (MÇU)<br>São Miguel do Cambuí (MVA) 1<br>Aquidaban (MVA)</p>`;  
            ...
            res.innerHTML = `<p><strong>2ª Segunda - Hora: 19:30</strong></p>
                             <p>Jd. Bertioga<br>Jardim Monte Rei<br>Jardim Vitória<br>Loteamento Sumaré<br>Parque Itaipú<br>Jardim Europa (MÇU)<br>Res. Monte Carmelo (PDU)<br>São Jorge do Ivai - Central</p>`;  
        } else if (b == '3 segunda' || b == 'terceira segunda') {
            res.innerHTML = `<p><strong>3ª Segunda - Hora: 19:30</strong></p>
                             <p>Jd. Verônica<br>Pq. Hortência 1ª Parte<br>Vila Santo Antônio<br>Jd. Bela Vista (Antigo Oriental) - (Os ensaios serão na igreja Jd. Oriental)<br>Mandaguaçu - Central<br>Santa Fé (MVA)<br>Paiçandu - Central<br>Jd. Panorama (SDI)<br>Cj. Res. Floresta (SDI)<br>Bentópolis (JTÃ)</p>`;  
